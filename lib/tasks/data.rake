namespace :data do
  ...
  task :add_departments => [:environment] do
    ...
    Department.create! :name => 'Anchorage Authority for Rapid Transit', :acronym => 'HART'
    Department.create! :name => 'Anchorage Fire Department', :acronym => 'HFD'
    Department.create! :name => 'Anchorage Police Department', :acronym => 'HPD'
